...
@section('content')
                            ...
                            <div class="col ">
                                <div class="mb-1">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="kd_kab"
                                        ...
                                        @foreach ($kabs as $kab)
                                            @if ($kab->id_kab == $perusahaan->kd_kab)
    ...
    <script>
        ...
        var kab = @json($perusahaan->kd_kab);
        var kec = @json($perusahaan->kd_kec);
        var desa = @json($perusahaan->kd_desa);
        $(document).ready(function() {
            $('#kd_kab').val(kab).change();
            getkec()
            setTimeout(function() {
                $('#kd_kec').val(kec).change()
                getdesa()
            }, 700);

            setTimeout(function() {
                $('#kd_desa').val(desa).change()
            }, 1700);
