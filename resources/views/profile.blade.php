            ...
            <fieldset class="p-5">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="nama_perusahaan" name="nama_perusahaan"
                            value="{{ old('nama_perusahaan', $auth->nama_perusahaan) }}">
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class=" mb-3 row">
                    ...
                    {{-- <input type="text" class="form-control" id="alamat_kantor" name="alamat_kantor"
                        value="{{old('alamat_kantor', $auth->alamat_kantor)}}"> --}}
                    <div class=" col-sm-8">
                        <textarea name="alamat_kantor" id="alamat_kantor" rows="5" class="form-control">{{ old('alamat_kantor', $auth->alamat_kantor) }}</textarea>
                    </div>
                    {{-- </div> --}}
                </div>
                <div class="mb-3 row">
                    ...
                    <div class=" col-sm-8">
                        <textarea name="alamat_pusat" id="alamat_pusat" rows="5" class="form-control">{{ old('alamat_pusat', $auth->alamat_pusat) }}</textarea>
                    </div>
                    {{-- </div> --}}
                </div>
