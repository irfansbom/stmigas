    ...
    <div class="fixed-bottom bg-dark">
        <div class="container px-1">
            <div class="container py-2 px-3 d-flex justify-content-between">
                ...
                <button class="btn btn-primary btn-sm" type="submit" form="blok3_form">Simpan</button>
                <div class=" me-2" role="group" aria-label="First group">
                    <a class="btn btn-warning btn-sm" href="{{ url('showblok2/' . \Crypt::encryptString($id)) }}">
                        Kembali</a>
                    <a class="btn btn-warning btn-sm" href="{{ url('showblok4/' . \Crypt::encryptString($id)) }}">Lanjut
                    </a>
                </div>
            </div>
        </div>
