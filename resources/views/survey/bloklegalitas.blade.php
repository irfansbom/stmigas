    ...
    <div class="fixed-bottom bg-dark">
        <div class="container px-1">
            <div class="container py-2 px-3 d-flex justify-content-between">
                ...
                <button class="btn btn-primary btn-sm" type="submit" form="bloklegalitas_form">Simpan</button>
                <div class=" me-2" role="group" aria-label="First group">
                    <a class="btn btn-warning btn-sm"
                        href="{{ url('showblok5/' . \Crypt::encryptString($id)) }}">Kembali</a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger" class="lanjutkansaja" href="{{ url('dashboard') }}">Tidak, Lanjutkan
                        saja</a>
                </div>
            </div>
        </div>
