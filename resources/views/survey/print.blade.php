...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/css/bootstrap-print.min.css') }}" media="all">
    <link rel="stylesheet" href="{{ url('css/bootstrap.min.css') }}" media='all'>
    <script src="{{ url('js/jspdf.umd.min.js') }}"></script>
    ...
    <div class="mb-1 row">
        <div class="col-sm-2 d-flex  align-items-center">
            <table class="table text-center table-bordered border-dark">
                <tr>
                    <td style=" border-color: #000000 !important;">RAHASIA</td>
                </tr>
                <tr>
                    <td class="text-light " style="background: #000000!important; border-color: #000000!important">
                        CONFIDENTIAL</td>
                </tr>
            </table>
        </div>
        ...
        <div class="col-sm-2 d-flex  align-items-center">
            <table class="table text-center table-borderless">
                <tr>
                    <th rowspan="2" class="bg-danger text-light"
                        style="font-size: 20px; background:#dc3545!important;
                    ">MIGAS</th>
                </tr>
            </table>
        </div>
    ...
    <form>
        <fieldset>
            ...
            <table class="table table-bordered border-dark mb-0">
                <tr>
                    <td class="px-5 py-3" style="border-color: #000000 !important;">
                        <div class=" mb-1 row">
                    ...
                    <td class="px-2 py-0" style="width:15%; border-color:#000000 !important;">
                ...
                <tr>
                    <td class="px-5 py-3" colspan="2" style="border-color: #000000 !important;">
                        <div class="mb-1 row">
                        ...
                        <div class="mb-1 row">
                            ...
                            <div class="col-sm-9 d-flex align-items-center">
                                <textarea type="text" class="form-control" id="alamat_perusahaan" name="alamat_perusahaan">{{ old('alamat_perusahaan', $survey->alamat_perusahaan) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-1 row">
                            ...
                            <div class="col-sm-4 d-flex align-items-center">
                                <input type="tel" class="form-control" id="phone_perusahaan"
                ...
                <tr>
                    <td>
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-sm-1 text-end"><strong>:</strong></div>
                            <div class="col-sm-8 fst-italic">To obtain of oil and gas mining data for national
                                developmennt
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-sm-1 text-end"><strong>:</strong></div>
                            <div class="col-sm-8">Identitas dan seluruh informasi perusahaan akan tetap dirahasiakan
                                dan
                                tidak
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-sm-1 text-end"><strong>:</strong></div>
                            <div class="col-sm-8 fst-italic">Identity and all company information will remain secret
                                and
                                will
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-sm-1 text-end"><strong>:</strong></div>
                            <div class="col-sm-8 fst-italic">The survey is free of charge and has no related with
                                taxes.
                            </div>
                        </div><br>
                        <div class="row mb-1">
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-sm-1 text-end"><strong>:</strong></div>
                            <div class="col-sm-8 fst-italic">Please send this document to BPS before August 1st 2022.
                            </div>
                        </div>
                    </td>
                </tr>
            ...
            <table style="font-size: 10px" class="table table-sm table-borderless">
                <tr>
                    <th class="text-center  border-top border-bottom border-dark" colspan="2">Keterangan Lebih
                    </th>
                </tr>
                <tr>
            ...
            <table class="table  table-borderless">
                ...
                <tr class="text-end">
                    <td style="font-size: 14px">
                        ...
                        <span style="font-size: 12px"> Diisi Oleh BPS/<span class="fst-italic">Filled by
                                BPS</span></span>
                        <div class="mb-1 row">
                            <div class="col-sm-9"></div>
                            <div class="col-sm-3 d-flex align-items-center">
                                <input type="text" class="form-control form-control-sm" id="kbli"
                        ...
                        <div class="mb-1 row ">
                            ...
                            <div class="ps-5 pe-0">
                                <table class="table table-sm table-bordered border-dark text-center align-middle"
                                    ...
                                    <tr style="border-color: #000000 !important;">
                                        <td>No</td>
                                        <td>Nama/Name</td>
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    <td>
                        <div class="mb-1 row ">
                            <label for="bentuk_kerjasama" class="col-sm-12 col-form-label">
                                <strong>202. Banyaknya Pekerja Tetap dan Kontrak Menurut Tingkat Pendidikan Tertinggi
                                    yang
                            ...
                            <div class="ps-5 pe-0">
                                <table class="table table-sm table-bordered border-dark align-middle"
                                    ...
                                    <tr>
                                        <td>
                                            a. SLTP dan Sederajat atau lebih rendah /<span class="fst-italic">Junior
                                                High
                                                School
                        ...
                        <div class="mb-1 row ms-4">
                            ...
                            <div class="col-sm-12" style="font-size: 12px">
                                ...
                                jangka
                                waktu terbatas dan tidak memiliki kesempatan dalam jejang karir sesuai aturan
                                perusahaan.
                            </div>
                            <div class="col-sm-12 fst-italic mb-2" style="font-size: 12px">
                                <strong>Contract workers</strong> are workers who are employed by the company for a
                                limited
                                period of time and do not have career opportunities according to company regulations.
                            </div>
                            <div class="col-sm-12" style="font-size: 12px">
                                <strong>Pekerja outsourcing </strong> adalah pekerja yang direkrut dari perusahaan
                                penyalur
                                tenaga kerja untuk jangka waktu pendek dan menangani pekerjaan khusus baik produksi
                                maupun
                                non
                                produksi.
                            </div>
            ...
            <table class="table table-borderless">
                ...
                <tr>
                    <td>
                        ...
                        <div class="mb-1 row  pe-0">
                            <table class="table table-bordered border-dark border align-middle table-sm"
                                style="font-size: 14px; ">
                                <tr class="text-center">
                    ...
                    <td>
                            ...
                            <table class="table table-bordered border-dark align-middle table-sm"
                                ...
                                <tr>
                                    <td>b. Biaya angkutan migas ke penampungan utama di lokasi penambangan<br>
                                        <span class="fst-italic">&nbsp; &nbsp; Transportation cost include of oil and
                                            gas
                                            field
                        ...
                        <div class="mb-1 row ">
                            <div class="col-sm-12 ps-0 fst-italic" style="font-size: 12px">
                                ...
                                include the cost of underground drainage and oil and gas field storage facilities
                                process
                            </div>
                        </div>
                        <br>
                        <div class="mb-1 row ">
                            <div class="col-sm-12 ps-0" style="font-size: 12px">
                                ...
                                mencakup pengiriman migas dari lapangan migas ke penyimpanan utama sebelum penjualan
                                atau
                        ...
                        <div class="mb-1 row ">
                            <div class="col-sm-12 ps-0 fst-italic" style="font-size: 12px">
                                ...
                                include delivery of oil and gas from oil and gas field to the main storage before sale
                                or
                                further processing
                            </div>
                        </div> <br>
                ...
                <tr>
                    <td>
                        <div class="mb-1 row d-flex align-items-center mt-5">
                            <label for="biaya_pengurasan" class="col-sm-9 col-form-label">
                        ...
                        <div class=" mb-1 row  pe-0">
                            <table class="table table-bordered border-dark align-middle table-sm"
                                style="font-size: 14px">
                                <tr class="text-center">
                                    <th rowspan="2">Jenis Bahan Bakar dan Pelumas <br> <span
                                            class="fst-italic">Kind of
                                            Fuels
                                            and
                                            Lubricants</span>
                                    </th>
                                ...
                                <tr>
                                    <td>d. Minyak Solar/Gas Oil/<span class="fst-italic">Automotive Diesel Oil</span>
                                    </td>
                                    <td class="text-center">Liter</td>
                                    <td>
                                        <input type="text" class="form-control form-control-sm text-end mask"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center bg-secondary" style="background-color:#6C757D !important">
                                    </td>
                            ...
                            <table class="table table-bordered border-dark align-middle table-sm"
                                ...
                                <tr>
                                    <td>b. Alat tulis kantor dan perlengkapan kantor <br>
                                        <span class="fst-italic">&nbsp; &nbsp; Stationaries and computer
                                            supplies</span>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control form-control-sm"
                                ...
                                <tr>
                                    <td>c. Pembelian peralatan dan perlengkapan pertambangan yang penggunaannya kurang
                                        dari
                                        satu
                                        tahun<br>
                                ...
                                <tr>
                                    <td>d. Sewa kendaraan, mesin dan peralatan lainnya<br>
                                        <span class="fst-italic">&nbsp; &nbsp; Rent expenditures for vehicles,
                                            machinery
                                            and
                                ...
                                <tr>
                                    <td>f. Biaya jasa pertambangan yang dikerjakan pihak lain<br>
                                        <span class="fst-italic">&nbsp; &nbsp; Cost of service carried out by
                                            other</span>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control form-control-sm text-end mask"
                                ...
                                <tr>
                                    <td>s. Lainnya, seperti : iklan, riset pemasaran kehumasan dan sejenisnya<br>
                                        <span class="fst-italic">&nbsp; &nbsp; Other, i.o : promotion, market
                                            research,
                                            charity,
                                            etc</span>
                                    </td>
                    ...
                    <td>
                        ...
                        <div class="mb-1 row ">
                            ...
                            <div class="col-sm-12 ps-4 fst-italic" style="font-size: 12px">
                                ...
                                include the cost of the investigation topography, geology, geophysics, drilling
                                exploration
                                wells, drilling of stratigraphic test wells, development of proven reserves of oil and
                                gas
                                until
                        ...
                        <div class="mb-1 row pe-0">
                            <table class="table table-bordered border-dark align-middle table-sm"
                                ...
                                <tr>
                                    ...
                                    <td class="bg-secondary" style="background-color:#6C757D !important"></td>
                                </tr>
                                <tr>
                                ...
                                <tr class="border-0">
                                    <td class="border-end-0" style="border-right-width: 0px !important"> &nbsp;
                                        &nbsp;
                                        a. Minyak
                        ...
                        <div class="mb-1 row ">
                            <table class="table table-bordered border-dark align-middle table-sm"
                                ...
                                <tr class="">
                                    <td class="px-5">
                                        <div class="mb-2 row">
                                            <div class="col-sm-12">Data dalam daftar isian ini diisi dengan sebenarnya
                                                dan
                                        ...
                                        <div class="mb-1 row d-flex align-items-center">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control form-control-sm"
                                                    id="pemberi_keterangan_jabatan"
                                                    name="pemberi_keterangan_jabatan"
                    ...
                    <td>
                        <div class="mb-1 row ">
                            <table class="table table-bordered border-dark align-middle table-sm"
                                style="font-size: 14px">
                                <tr class="text-center">
                                    <th class="bg-secondary" style="background-color:#6C757D !important"></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-control-sm"
                                            id="pencacah_nama" name="pencacah_nama"
                                            value="{{ old('pencacah_nama', $survey->pencacah_nama) }}">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control form-control-sm"
                                            id="pengawas_nama" name="pengawas_nama"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-control-sm"
                                            id="pencacah_jabatan" name="pencacah_jabatan"
                                            value="{{ old('pencacah_jabatan', $survey->pencacah_jabatan) }}">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control form-control-sm"
                                            id="pengawas_jabatan" name="pengawas_jabatan"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-control-sm"
                                            id="pencacah_no_hp" name="pencacah_no_hp"
                                            value="{{ old('pencacah_no_hp', $survey->pencacah_no_hp) }}">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control form-control-sm"
                                            id="pengawas_no_hp" name="pengawas_no_hp"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-control-sm"
                                            id="pencacah_tanggal" name="pencacah_tanggal"
